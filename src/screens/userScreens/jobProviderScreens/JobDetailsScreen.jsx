...
const JobDetailsScreen = () => {
  ...
  const facebookUrl = getSocialUrl("facebook", jobData.facebook || jobData.facebook_url || jobData.facebookUrl);
  const twitterUrl = getSocialUrl("twitter", jobData.twitter || jobData.twitter_url || jobData.twitterUrl || jobData.x);
  const linkedinUrl = getSocialUrl("linkedin", jobData.linkedin || jobData.linkedIn || jobData.linkedin_url || jobData.linkedinUrl);
  const instagramUrl = getSocialUrl("instagram", jobData.instagram || jobData.instagram_url || jobData.instagramUrl);
  ...
  return (
    <Container style={[
      ...
      >
            ...
            <View style={styles.headerInfo}>
              ...
              {(facebookUrl || twitterUrl || linkedinUrl || instagramUrl) && (
                <View style={styles.socialIconsRow}>
                  {facebookUrl ? (
                    <TouchableOpacity style={styles.socialIconButton} onPress={() => openSocialLink(facebookUrl)} activeOpacity={0.7}>
                      <Image source={FACEBOOK} style={styles.socialIconImage} />
                    </TouchableOpacity>
                  ) : null}
                  {twitterUrl ? (
                    <TouchableOpacity style={styles.socialIconButton} onPress={() => openSocialLink(twitterUrl)} activeOpacity={0.7}>
                      <Image source={TWITTER} style={styles.socialIconImage} />
                    </TouchableOpacity>
                  ) : null}
                  {linkedinUrl ? (
                    <TouchableOpacity style={styles.socialIconButton} onPress={() => openSocialLink(linkedinUrl)} activeOpacity={0.7}>
                      <Image source={LINKEDIN} style={styles.socialIconImage} />
                    </TouchableOpacity>
                  ) : null}
                  {instagramUrl ? (
                    <TouchableOpacity style={styles.socialIconButton} onPress={() => openSocialLink(instagramUrl)} activeOpacity={0.7}>
                      <Image source={INSTAGRAM} style={styles.socialIconImage} />
                    </TouchableOpacity>
                  ) : null}
                </View>
              )}
        ...
        {/* Company Address Section - Always visible */}
